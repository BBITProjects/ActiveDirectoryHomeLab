...
<br/>
Read the diagram top to bottom. Internet will go through the domain controller (DC), which will be passed through the virtual machine (VM) to the Client. 
...
<img src="https://imgur.com/JlkXsLd.jpg" height="80%" width="80%" alt="DC VM Creation"/>
